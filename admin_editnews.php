...
if($_GET["dosubmit"] == "1") {
    ...
    if($message == "") {
        $sql = "update news set title='$title',content='$content',pubtime='$datetime', category_id={$category_id} where id={$id} ";
        if(mysql_query($sql)) {
            $message = "更新完成";
...
<?php include("header.inc.php"); ?>
    ...
    <div class="jumbotron">
        ...
        <? } ?>
        <form action="admin_editnews.php?dosubmit=1" method="post" class="form-horizontal" >
            <fieldset>
...
<!--                        </div>-->
            ...
            <div class="pull-right">
                <button  class="btn btn-small btn-info" onclick="history.back();">返回</button>
                <button type="submit" class="btn btn-small btn-info" onclick="getcontent()">更新</button>
            </div>
        </form>
    </div>
<script>
